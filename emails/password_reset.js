                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text">
                                                                                        ...
                                                                                        <p style="text-align: left; color: #000000; font-size: medium;">Dear &lt;user-name&gt;,<br><br></p>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-button es-m-txt-c" bgcolor="#ffffff"><br><br><br><span class="es-button-border" style="border-radius: 8px; background: #6fd20d; border-color: #50b948;"><a href="${emailHost()}/confirmation-recovery/old-account/reset/${email}_${tokenString}" class="es-button" target="_blank" style="color: #000000; border-radius: 8px; font-weight: bold; font-size: 18px; font-family: arial, &quot;helvetica neue&quot;, helvetica, sans-serif; border-left-width: 20px; border-right-width: 20px; background: #6fd20d; border-color: #6fd20d;">Reset Password</a></span></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-text" bgcolor="#ffffff">
                                                                                        <p style="color: #000000; line-height: 200%; font-size:medium;">If that doesn't work, Copy and paste the link below to your browser.</p><br><a href="${emailHost()}/confirmation-recovery/old-account/reset/${email}_${tokenString}" style="font-size:medium;" target="_blank">${emailHost()}/confirmation-recovery/old-account/reset/${email}_${tokenString}</a><br><br>Please kindly ignore if you did not request for this action<br><br>
