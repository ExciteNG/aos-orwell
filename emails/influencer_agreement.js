...
const influencerAgreementEmail = (fullName,merchantName) => {
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="esd-block-text" align="center">
                                                                                            ...
                                                                                            <p style="color: #000000; font-size: medium;">This is to bring to your notice that you have agreed to market the product of the merchant ${merchantName}.<br><br>A mail will be sent to you confirming the payment of the merchant for the specified duration of time(Our service charges still apply).<br><br>If you have any questions or enquiries, just reply to this mail and we will be in touch shortly.<br><br></p>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
...
module.exports = influencerAgreementEmail;