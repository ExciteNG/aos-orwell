let x = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text" bgcolor="#ffffff">
                                                                                        ...
                                                                                        <p style="text-align: left; color: #000000; font-size: medium; line-height: 200%;">Dear User,<br><br>We are glad to inform you that your request for business registration has been submitted we will contact you very soon.<br><br>Best Regards,<br>The excite team</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text" align="center" bgcolor="#6fd20d">
                                                                                        <p style="font-size: 12px; line-height: 150%; color: #ffffff;">You are receiving this email because you attempted to register your business on the excite enterprise platform.</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
...
let newX = x.replace('<p style="color: #ffffff;">Company Number: 0701234522</p>','');
