const paymentNotification = async (influencerName,merchantName,amountToPay,duration) => {
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text" bgcolor="#ffffff" align="center">
                                                                                        <h3 style="color: #6fd20d; font-weight: 400; line-height: 200%;">NOTIFICATION OF PAYMENT BY MERCHANT FOR<br>INFLUENCER MARKETING</h3>
                                                                                        <p style="color: #6fd20d; line-height: 200%;"><br></p>
                                                                                        <p style="text-align: left; color: #000000; font-size: medium; line-height: 200%;">Dear ${influencerName},<br>&nbsp;&nbsp; You are receiving this email because a merchant with the name&nbsp;&nbsp; ${merchantName} has successfully completed payment of a sum of ${amountToPay} NGN for a duration of ${duration} months for your services&nbsp;&nbsp; as an influencer marketer to promote his/her products.<br><br>&nbsp;&nbsp;&nbsp; You should receive your remuneration as soon as possible(Our percentage charge policy still applies).<br><br>&nbsp;&nbsp;&nbsp;&nbsp; Please reply to this mail or call us via this number(09138650923) if you think there are any errors or inaccuracies in the details of this mail.<br><br></p>
                                                                    ...
                                                                    <td class="esd-container-frame" width="540" valign="top" align="center">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                        ...
                                                                                        <table class="es-table-not-adapt es-social" cellspacing="0" cellpadding="0">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td class="es-p10r" esd-tmp-icon-type="youtube" valign="top" align="center"><a target="_blank" href="https://www.youtube.com/channel/UCD8lc4GXY_wREScUP8miqVw"><img title="Youtube" src="https://liiueu.stripocdn.email/content/assets/img/social-icons/square-gray/youtube-square-gray.png" alt="Yt" width="24" height="24"></a></td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text" bgcolor="#6fd20d" align="center">
                                                                                        <p style="font-size: 12px; line-height: 150%; color: #ffffff;">You are receiving this email because a merchant requested for your services as an influencer on the excite enterprise platform</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
