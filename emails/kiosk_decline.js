                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="center" class="esd-block-text" bgcolor="#ffffff">
                                                                                            <h3 style="color: #6fd20d; font-weight: 400; line-height: 200%;">KIOSK APPLICATION STATUS</h3>
                                                                                            <p style="color: #6fd20d; line-height: 200%;"><br></p>
                                                                                            <p style="text-align: left; color: #000000; font-size: medium; line-height: 200%;">Dear User,<br><br>We regret to inform you that your application for a kiosk on the excite platform was not successful.<br>We strongly encourage you to review your entries and try again.<br><br>Best Regards,<br>The excite team</p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="esd-block-text" align="center" bgcolor="#6fd20d">
                                                                                            <p style="font-size: 12px; line-height: 150%; color: #ffffff;">You are receiving this email because you applied for&nbsp;a kiosk&nbsp;on the excite enterprise platform.</p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
