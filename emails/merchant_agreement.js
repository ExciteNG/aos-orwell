...
const merchantAgreementEmail = (fullName,influencerName) => {
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="esd-block-text" align="center">
                                                                                            <h3 style="color: #6fd20d; font-weight: 400;"><br>INFLUENCER MARKETING AGREEMENT</h3>
                                                                                            <p style="color: #6fd20d;"><br></p>
                                                                                            <p style="text-align: left; color:#000000; font-size: medium;">Dear ${fullName},<br><br></p>
                                                                                            <p style="color: #000000; font-size: medium;">This is to notify you that the influencer marketer by the name of ${influencerName} has agreed to help influence your product.<br><br>You can confirm this action by checking your&nbsp;<a href="https://www.exciteenterprise.com/influencer-marketing/merchant/dashboard" target="_blank" style="font-size: 16px;">dashboard</a> after which you can proceed to payment <a href="https://www.exciteenterprise.com/influencer-marketing/merchant-agree-price" target="_blank" style="font-size: 16px;">Here</a>.<br><br>If you have any questions or enquiries, just reply to this mail and we will be in touch shortly.<br><br></p>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td class="esd-container-frame" width="540" valign="top" align="center"> ${socialMediaLinks()} <table width="100%" cellspacing="0" cellpadding="0">
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="esd-block-text" bgcolor="#6fd20d" align="center">
                                                                                            <p style="font-size: 12px; line-height: 150%; color: #ffffff;">You are receiving this email because you are a registered merchant on the excite enterprise platform.</p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
...
module.exports = merchantAgreementEmail;