                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="center" class="esd-block-text">
                                                                                            <h3 style="color: #000000; font-weight:600; font-size:xx-large">Welcome !</h3>
                                                                                            <p style="color: #000000;"><br></p>
                                                                                            <p style="text-align: left; color: #000000; font-size: medium;">Dear ${fullname},<br><br></p>
                                                                                            <p style="color: #000000; font-size: medium;">We are excited to welcome&nbsp;you on our platform. First, you need to confirm your account. Please click on the button&nbsp;below to do so</p>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td align="center" class="esd-block-button es-m-txt-c" bgcolor="#ffffff"><br><br><br><span class="es-button-border" style="border-radius: 8px; background: #6fd20d; border-color: #50b948;"><a href="http://localhost:3000/confirmation/email/${email}_${tokenString}" class="es-button" target="_blank" style="color: #000000; border-radius: 8px; font-weight: bold; font-size: 18px; font-family: arial, &quot;helvetica neue&quot;, helvetica, sans-serif; border-left-width: 20px; border-right-width: 20px; background: #6fd20d; border-color: #6fd20d;"> Confirm Account </a></span></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td align="left" class="esd-block-text" bgcolor="#ffffff">
                                                                                            <p style="color: #000000; line-height: 200%; font-size:medium;">If that doesn't work,Copy and paste the link below to your browser.</p><br><a href="http://localhost:3000/confirmation/email/${email}_${tokenString}" style="font-size:medium;" target="_blank">http://localhost:3000/confirmation/email/${email}_${tokenString}</a><br><br><br>
                                                                        ...
                                                                        <td class="esd-container-frame" width="540" valign="top" align="center">
                                                                            <table width="100%" cellspacing="0" cellpadding="0">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="center" class="esd-block-text">
                                                                                            <p style="color: #ffffff;">You received this email because you just signed up&nbsp; for a new account&nbsp;on the excite platform</p>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
