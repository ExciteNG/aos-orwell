                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="left" class="esd-block-text" bgcolor="#ffffff">
                                                                                            <p style="color: #000000; line-height: 200%; font-size:medium;">If that doesn't work,Copy and paste the link below to your browser.</p><br><a href=${emailHost}/confirmation/email/${email}_${tokenString}" style="font-size:medium;" target="_blank">http://localhost:3000/confirmation/email/${email}_${tokenString}</a><br><br><br>
