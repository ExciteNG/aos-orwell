...
const invoiceMail =  (productName,price,quantity,total)  => {
                                        ...
                                        <td class="esd-stripe" align="center">
                                            <table bgcolor="#ffffff" class="es-content-body" align="center" cellpadding="0" cellspacing="0" width="600">
                                                <tbody>
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="center" class="esd-block-text">
                                                                                            <h3 style="color: #6fd20d; font-weight:540; font-size:x-large">INVOICE FOR ${productName}</h3>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td align="left" class="esd-block-text" bgcolor="#ffffff">
                                                                                            <p style="color: #000000; line-height: 200%; font-size:medium;"><br>Dear customer,<br>&nbsp; &nbsp; &nbsp; &nbsp;Please find the invoice on the&nbsp;product you purchased below:</p>
                                                                                            <p style="color: #000000; line-height: 100%; font-size:medium;"><br></p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                    ...
                                                    <tr>
                                                        <td class="esd-structure" align="left" bgcolor="#6fd20d" style="background-color: #6fd20d;">
                                                            <!--[if mso]><table width="600" cellpadding="0" cellspacing="0"><tr><td width="202" valign="top"><![endif]-->
                                                            <table cellpadding="0" cellspacing="0" class="es-left" align="left">
                                                                <tbody>
                                                                    <tr>
                                                                        <td width="172" class="es-m-p0r es-m-p20b esd-container-frame" align="center">
                                                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="center" class="esd-block-text" bgcolor="#6fd20d">
                                                                                            <p style="color: #000000;"><strong>PRODUCT NAME</strong></p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                        ...
                                                                        <td width="113" class="es-m-p20b esd-container-frame" align="center">
                                                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="center" class="esd-block-text" bgcolor="#6fd20d">
                                                                                            <p style="color: #000000;"><strong>UNIT COST</strong></p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                        ...
                                                                        <td width="113" class="es-m-p20b esd-container-frame" align="center">
                                                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="center" class="esd-block-text" bgcolor="#6fd20d">
                                                                                            <p style="color: #000000;"><strong>QUANTITY</strong></p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                            ...
                                                            <!--[if mso]></td><td width="30"></td><td width="112" valign="top"><![endif]-->
                                                            <table cellpadding="0" cellspacing="0" class="es-right" align="right">
                                                                <tbody>
                                                                    <tr>
                                                                        <td width="112" align="center" class="esd-container-frame">
                                                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="center" class="esd-block-text" bgcolor="#6fd20d">
                                                                                            <p style="color: #000000;"><strong>TOTAL</strong></p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                    ...
                                                    <tr>
                                                        <td class="esd-structure es-p20" align="left">
                                                            <!--[if mso]><table width="560" cellpadding="0" cellspacing="0"><tr><td width="138" valign="top"><![endif]-->
                                                            <table cellpadding="0" cellspacing="0" class="es-left" align="left">
                                                                <tbody>
                                                                    <tr>
                                                            ...
                                                            <!--[if mso]></td><td width="197" valign="top"><![endif]-->
                                                            <table cellpadding="0" cellspacing="0" class="es-left" align="left">
                                                                <tbody>
                                                                    <tr>
                                                                        <td width="187" class="es-m-p20b esd-container-frame" align="center">
                                                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="center" class="esd-block-text" bgcolor="#ffffff">
                                                                                            <p style="color: #000000;font-size:medium">${price}</p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                            ...
                                                            <!--[if mso]></td><td width="78" valign="top"><![endif]-->
                                                            <table cellpadding="0" cellspacing="0" class="es-left" align="left">
                                                                <tbody>
                                                                    <tr>
                                                                        <td width="78" class="es-m-p20b esd-container-frame" align="center">
                                                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="center" class="esd-block-text" bgcolor="#ffffff">
                                                                                            <p style="color: #000000;font-size:medium">${quantity}</p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                            ...
                                                            <!--[if mso]></td><td width="10"></td><td width="137" valign="top"><![endif]-->
                                                            <table cellpadding="0" cellspacing="0" class="es-right" align="right">
                                                                <tbody>
                                                                    <tr>
                                                                        <td width="137" align="center" class="esd-container-frame">
                                                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="center" class="esd-block-text" bgcolor="#ffffff">
                                                                                            <p style="color: #000000;font-size:medium;">${total}</p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                        ...
                                                                        <td class="esd-container-frame" width="540" valign="top" align="center">
                                                                            <table width="100%" cellspacing="0" cellpadding="0">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="center" class="esd-block-text">
                                                                                            <p style="color: #ffffff;">You received this email because you attempted to (or actually) purchased a product&nbsp;on the excite enterprise marketplace platform</p>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
