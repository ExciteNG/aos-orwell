...
//define a hhelper mail function

let sendMail = (userName) => {
    
    let mail = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                                                                    ...
                                                                    <td width="560" class="esd-container-frame" align="center" valign="top">
                                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text"><br>Our services include, but not limited to:</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text"><br><strong>Access To Funds:</strong> Get access to funds to grow your business.</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text"><br><strong>Automation Tools (Ease of Business):</strong></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text">Get your business registered within a week. </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text">Pay your taxes. </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text">all from the comfort of your home. </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text"><br>Growth and Expansion Tools </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text">Take advantage of our Excite Kiosk service and get your business place setup in no time. </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text">Put your business in front of millions of potential customers with our Banner Advert services. </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text">List your products and services for free. </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text"><br>.. And much more ! </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="“left”" class="esd-block-text"><br>
                                                                                        <p style="color:black; font-weight:600;">ONBOARDING</p><br>
                                                                                        <p style="font-size:medium; color:#000000;">To get started, Click the link below to watch a short video explaining our Excite platform;<br><a href>Video</a><br> To visit the Excite platform directly, kindly click excite link <a href>here</a><br> If you have any questions, kindly reply to this email or reach us on the following contacts:<br> excite phone number<br> excite customer care email<br></p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p15t es-p5b" align="center" bgcolor="#6fd20d">
                                                                                        ...
                                                                                        <p style="color: #ffffff;">Company Number: 07012345</p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text" align="center" bgcolor="#6fd20d">
                                                                                        <p style="font-size: 12px; line-height: 150%; color: #ffffff;">You are receiving this email because you have visited our site or asked us about regular newsletter. Make sure our messages get to your Inbox (and not your bulk or junk folders). Please add hello@bookkeeping.com to your contacts</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
