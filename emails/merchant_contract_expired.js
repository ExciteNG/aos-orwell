...
const merchantContractExpired = (fullName,influencerName,price,duration) => {
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="esd-block-text" align="center">
                                                                                            ...
                                                                                            <p style="color: #000000; font-size: medium;">This is to notify you that&nbsp; your contract with the influencer marketer by the name of ${influencerName} costing ${price} for ${duration} months has expired.<br><br>You can sign another contract with this particular influencer or get another influencer by logging in to your dashboard&nbsp; <a href="https://www.exciteenterprise.com/influencer-marketing/merchant/dashboard/" target="_blank" style="font-size: 16px;">Here</a>.<br><br>If you have any questions or enquiries, just reply to this mail and we will be in touch shortly.<br></p>
...
module.exports = merchantContractExpired